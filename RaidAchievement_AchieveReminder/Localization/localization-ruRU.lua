...
ralldefaulttactic82			= "Возможно баг: рудниковые крысы пока убиваются только с помощью АоЕ заклинаний."
ralldefaulttactic83			= "Опытная модель жнеца имеет иммунитет к урону от огненных аддов, поэтому убивайте их жнецом подальше от босса. Возможно баг: достижение проваливается даже если ХП жнеца опустятся ниже 90% на треше, ДО боя с боссом, после вайпа достижение получить пока не удается"
