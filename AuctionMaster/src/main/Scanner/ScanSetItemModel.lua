...
local function _InitDescriptors(self)
	self.descriptors = {
		[vendor.ScanSetItemModel.TEXTURE] = {type = "texture", title = L["Texture"], order = 1};
		[vendor.ScanSetItemModel.NAME] = {type = "text", align = "LEFT", weight = 35, minWidth = 60, sortable = true, title = L["Name"], order = 2};
		[vendor.ScanSetItemModel.COUNT] = {type = "number", align = "CENTER", weight = 10, minWidth = 20, sortable = true, title = L["Itms."], order = 3};
		[vendor.ScanSetItemModel.OWNER] = {type = "text", align = "CENTER", weight = 15, minWidth = 60, sortable = true, title = L["Seller"], order = 4};
		[vendor.ScanSetItemModel.BID] = {type = "text", align = "RIGHT", weight = 20, minWidth = 70, sortable = true, title = L["Bid"], order = 5};
		[vendor.ScanSetItemModel.BUYOUT] = {type = "text", align = "RIGHT", weight = 20, minWidth = 70, sortable = true, title = L["Buyout"], order = 6};
	}
end
...
function vendor.ScanSetItemModel.prototype:GetHighlight(row)
	...
	if (self.scanSet) then
    	...
    	local idx = self.index[row].idx
    	local key, time, timeLeft, count, minBid, minIncrement, buyoutPrice, bidAmount, owner, highBidder = self.scanSet:Get(idx)
    	log:Debug("GetHighlight highBidder [%s]", highBidder)
