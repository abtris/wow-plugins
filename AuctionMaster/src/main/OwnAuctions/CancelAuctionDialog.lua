...
local function _InitCancelFrame(self)
	...
	local but1 = CreateFrame("Button", nil, frame, "UIPanelButtonTemplate");
	but1:SetText(L["Ok"]);
	but1:SetWidth(BUTTON_WIDTH);
	but1:SetHeight(22);
	but1:SetPoint("BOTTOM", frame, "BOTTOM", -40, 10);
	but1.ctrl = self;
	...
	but2 = CreateFrame("Button", nil, frame, "UIPanelButtonTemplate");
	but2.ctrl = self;
