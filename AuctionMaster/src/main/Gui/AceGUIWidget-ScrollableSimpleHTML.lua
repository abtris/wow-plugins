...
do
	...
	local function Update(self)
		...
		onVertScroll = self.scrollFrame:GetScript("OnVerticalScroll")
	...
	local function Constructor()
    	...
    	html:SetFontObject("h1", QuestTitleFont)
    	html:SetFontObject("h2", QuestTitleFont)
    	html:SetFontObject("h3", GameFontRed)
    	html:SetFontObject(QuestFont)
