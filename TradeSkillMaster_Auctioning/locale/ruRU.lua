...
L["ALT"] = "ALT"
L["Accept"] = "Принять"
L["Add a new player to your whitelist."] = "Добавить нового игрока в ваш белый список"
...
-- L["Advanced"] = ""
L["Advanced Price Settings (Market Reset)"] = "Расширеные настройки цены (Market Reset)"
...
L["Are you SURE you want to delete this category?"] = "Вы ТОЧНО уверены удалить эту категорию?"
L["Are you SURE you want to delete this group?"] = "Вы ТОЧНО уверены удалить эту группу?"
L["Are you sure you want to delete the selected profile?"] = "Вы точно уверены, что хотите удалить выбраный профиль?"
-- L["Auction Defaults"] = ""
-- L["Auctioning - Cancel"] = ""
...
L["Cancel All Items"] = "Отмените всё"
...
L["Delete existing and unused profiles from the database to save space, and cleanup the SavedVariables file."] = "Удалёные существующие профили тз бпзы дпанных занимают много место, очистите файл SavedVariables"
...
L["Disable auto cancelling"] = "Выключить автоотмену"
...
L["Displays the Auctioning log describing what it's currently scanning, posting or cancelling."] = "Показывает лог Аукциона, который в данный момент сканируется, выкладывается или отменяется."
...
L["Don't Post Items"] = "Нет выставлять товар"
L["Done Canceling"] = "Отмена завершена"
L["Done Posting"] = "Выставление лотов закончено"
L["Down"] = "Вниз"
L["Existing Profiles"] = "Существующий профиль"
-- L["Fallback price"] = ""
L["Finished Canceling"] = "Отмена завершена"
L["Finished Posting"] = "Выставление завершено"
-- L["Finished status report"] = ""
L["Fixed Gold Amount"] = "Фиксированое количество золота"
-- L["General"] = ""
...
L["Hide help text"] = "Скрыть подсказки помощи"
...
L["Hides all poor (gray) quality items from the 'Add items' pages."] = "Скрвывает все предметы \"серого\" качества на странице \"Добавить предметы\""
...
L["If you don't have enough items for a full post, it will post with what you have."] = "Если у вас нет достаточно предметов для полного выставления, эти предметы будут выставлены когда они будут у вас."
-- L["Ignore stacks over"] = ""
-- L["Ignore stacks under"] = ""
L["Important! Please read!"] = "Внимание! Пожалуйста прочтите!"
L["Invalid category name."] = "Неверное имя категории."
L["Invalid group name."] = "Неверное имя группы."
L["Invalid monney format entered, should be \"#g#s#c\", \"25g4s50c\" is 25 gold, 4 silver, 50 copper."] = "Неверный формат денег, должно быть \"#g#s#c\", \"25g4s50c\" - это 25 золота, 4 сереба и 50 бронзы."
-- L["Invalid percent format entered, should be \"#%\", \"105%\" is 105 percent."] = ""
L["Invalid time entered, should either be 12 or 2 you entered \"%s\""] = "Выставлено неверное время, должно быть 12 или 2, вы ввели \"%s\""
...
L["Mass cancelling posted items"] = "Массовая отмена лотов"
L["Mass cancelling posted items below %s"] = "Массовая отмена лотов,которые ниже %s"
...
L["Maximum Price Settings (Fallback)"] = "Настройки максимальнй цены (Fallback)"
...
L["Nothing to cancel. No matches found for \"%s\""] = "Нечего отменять. Не найдено совпадений для \"%s\""
...
L["Rename this group to something else!"] = "Переименуйте эту группу в какую либо другую!"
...
L["Retry %s of %s for %s"] = "Возвращает %s из %s для %s"
...
Пожалуйста, нажмите ОК для того, что бы отключить APM и перезагрузите интерфейс жля того, что бы ваши настройки были перенесены!]=]
L[ [=[Welcome to TradeSkillMaster_Auctioning!
...
L["You do not have any items to post"] = "У вас ничего нет, что бы выставить"
