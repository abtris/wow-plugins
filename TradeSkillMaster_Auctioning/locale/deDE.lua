...
L["A category contains groups with similar settings and acts like an organizational folder. You may override default settings by category (and then override category settings by group)."] = "Eine Kategorie enthält Gruppen mit ähnlichen Einstellungen und fungiert wie ein organisatorisches Faltblatt. Sie können Standardeinstellungen durch Kategorie aufheben (und Kategorieneinstellungen durch Gruppe dann aufheben). " -- Needs review
L["A group contains items that you wish to sell with similar conditions (stack size, fallback price, etc).  Default settings may be overridden by a group's individual settings."] = "Eine Gruppe enthält Einzelteile, die Sie mit ähnlichen Zuständen (Stapelgröße, Rückfallspreis, usw.) verkaufen möchten. Standardannahmen können durch Einstellungen einer Gruppe aufgehoben werden. " -- Needs review
L["ALT"] = "ALT"
...
L["Add/Remove Items"] = "Hinzufügen/Entfernen von Items"
-- L["Advanced"] = ""
L["Advanced Price Settings (Market Reset)"] = "Erweiterte Preiseinstellungen (Markt Reset)"
L["Any of your auctions which match this text will be canceled. For example, if you enter \"glyph\", any item with \"glyph\" in its name will be canceled (even ones not in a group)."] = "Alle Deiner Auktionen, die zu diesem Text passen werden abgebrochen. Als Beispiel: Wenn du \"Glyphe\" eingibst, werden alle Gegenstände mit \"Glyphe\" im Namen abgebrochen. Auch Gegenstände, die nicht in Gruppen sind."
L["Are you SURE you want to delete this category?"] = "Bist du sicher, das du diese Kategorie löschen möchtest?"
L["Are you SURE you want to delete this group?"] = "Bist du sicher, das du diese Gruppe löschen möchtest?"
L["Are you sure you want to delete the selected profile?"] = "Bist du sicher das, du das ausgewählte Profil löschen möchtest?"
L["Auction Defaults"] = "Auktionen - Standards"
L["Auctioning - Cancel"] = "Auktionen - Abbrüche"
L["Auctioning - Cancel All"] = "Auktionen - Alles abbrechen"
L["Auctioning - Cancel All Scan"] = "Auktionen - Alle Scans abbrechen"
...
L["Auctioning will post at %s when there are no other auctions up."] = "Gegenstände werden zum Preis von %s erstellen, wenn keine anderen Auktionen dieses Gegenstandes verfügbar sind."
L["Auctioning will post at %s when you are the only one posting below %s."] = "Gegenstände werden zum Preis von %s erstellen, wenn Du Der einzige bist, der unter dem Preis von %s liegt."
L["Auctioning will undercut your competition by %s. When posting, the bid of your auctions will be set to %s percent of the buyout."] = "Gegenstände deiner Konkurrenz werden um %s unterboten. Beim erstellen wird das Gebot zu %s Prozent des Sofortkaufpreises eingestellt"
L["Auctions will be posted at %s when the market goes below your threshold."] = "Gegenstände werden als %s erstellen, wenn der Markt unter deine Sicherheitsschwelle geht."
