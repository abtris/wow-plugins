...
VUHDO_CLASS_BUFFS = {
	...
	["PRIEST"] = {
		[VUHDO_SPELL_ID.BUFFC_FORTITUDE] = { -- 01
			{
				{ VUHDO_SPELL_ID.BUFF_POWER_WORD_FORTITUDE, VUHDO_BUFF_TARGET_RAID, VUHDO_SPELL_ID.BLOOD_PAKT },
			}
		},
		...
		[VUHDO_SPELL_ID.BUFFC_LEVITATE] = { -- 09
			{
				{ VUHDO_SPELL_ID.BUFF_LEVITATE, VUHDO_BUFF_TARGET_SINGLE },
			}
		},
		[VUHDO_SPELL_ID.BUFFC_PAIN_SUPPRESSION] = { -- 10
			{
	...
	["SHAMAN"] = {
		[VUHDO_I18N_BUFFC_FIRE_TOTEM] = { -- 01
			{
				{ VUHDO_SPELL_ID.BUFF_FLAMETONGUE_TOTEM, VUHDO_BUFF_TARGET_TOTEM }, -- @okcata
			},
			{
				{ VUHDO_SPELL_ID.BUFF_SEARING_TOTEM, VUHDO_BUFF_TARGET_TOTEM },-- @okcata
			},
			{
				{ VUHDO_SPELL_ID.BUFF_FIRE_ELEMENTAL_TOTEM, VUHDO_BUFF_TARGET_TOTEM },-- @okcata
			},
			{
				{ VUHDO_SPELL_ID.BUFF_MAGMA_TOTEM, VUHDO_BUFF_TARGET_TOTEM }, -- @okcata
			},
			{
		...
		[VUHDO_I18N_BUFFC_AIR_TOTEM] = { -- 02
			{
				{ VUHDO_SPELL_ID.BUFF_GROUNDING_TOTEM, VUHDO_BUFF_TARGET_TOTEM }, -- @okcata
			},
			{
				{ VUHDO_SPELL_ID.BUFF_WINDFURY_TOTEM, VUHDO_BUFF_TARGET_TOTEM }, -- @okcata
			},
			{
				{ VUHDO_SPELL_ID.BUFF_WRATH_OF_AIR_TOTEM, VUHDO_BUFF_TARGET_TOTEM }, -- okcata
			},
		},
		...
		[VUHDO_SPELL_ID.BUFFC_TIDAL_FORCE] = { -- 11
			{
				{ VUHDO_SPELL_ID.BUFF_TIDAL_FORCE, VUHDO_BUFF_TARGET_SELF },
			},
		},
		[VUHDO_SPELL_ID.BUFFC_NATURES_SWIFTNESS] = { -- 12
			{
	...
	["MAGE"] = {
		...
		[VUHDO_SPELL_ID.BUFFC_SLOW_FALL] = { -- 8
			{
	...
	["DEATHKNIGHT"] = {
		[VUHDO_SPELL_ID.BUFFC_HORN_OF_WINTER] = {
			{
				{VUHDO_SPELL_ID.BUFF_HORN_OF_WINTER , VUHDO_BUFF_TARGET_SELF },
			}
		},
...
VUHDO_CAST_ICON_DIFF = {
	...
	--[VUHDO_SPELL_ID.ANCESTRAL_HEALING] = "Interface\\Icons\\Spell_Shaman_GiftEarthmother",
