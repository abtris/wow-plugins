-- **************************************************************************
-- * Titan Currency .lua - VERSION 0.4.0
-- **************************************************************************
...
-- ******************************** Versions ********************************
-- 0.1.0 First shot let's see how it works
-- 0.2.0 Bug fix
-- 0.3.0 WOW version update to 3.2
-- 0.4.0 WOW version update to 3.3

-- ******************************** Constants *******************************
local TITAN_CURRENCY_ID = "Currency";
local TITAN_CURRENCY_COUNT_FORMAT = "%d";
local TITAN_CURRENCY_VERSION = "0.4.0";
