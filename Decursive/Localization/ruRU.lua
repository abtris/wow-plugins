...
if not L then
    T._LoadedFiles["ruRU.lua"] = "2.6.0.1";
    return;
end;
...
L["OPT_AUTOHIDEMFS_DESC"] = "Выберите, когда скрывать МФИ" -- Needs review
...
L["OPT_HIDEMFS_GROUP_DESC"] = "Скрывать МФИ, когда вы не находитесь в рейде" -- Needs review
L["OPT_HIDEMFS_NEVER"] = "Никогда" -- Needs review
L["OPT_HIDEMFS_NEVER_DESC"] = "Никогда не скрывать МФИ автоматически" -- Needs review
L["OPT_HIDEMFS_SOLO"] = "Один" -- Needs review
L["OPT_HIDEMFS_SOLO_DESC"] = "Скрывать МФИ, когда вы не находитесь в группе или в рейде" -- Needs review
