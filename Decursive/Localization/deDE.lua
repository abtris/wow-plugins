...
if not L then
    T._LoadedFiles["deDE.lua"] = "2.6.0.1";
    return;
end;
...
L["OPT_MUFMOUSEBUTTONS_DESC"] = "Maus-Schaltflächen einstellen, die du für jede Warnfarbe des Mikro-Einheiten-Rahmens benutzen möchtest." -- Needs review
