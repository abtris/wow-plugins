...
if not L then
    T._LoadedFiles["koKR.lua"] = "2.6.0.1";
    return;
end;
...
L["OPT_AUTOHIDEMFS"] = "MUF 숨김 시점:"
L["OPT_AUTOHIDEMFS_DESC"] = "자동으로 MUF 창을 숨겨두려면 선택합니다."
...
L["OPT_PERFOPTIONWARNING"] = "경고: 당신이 무엇인지 정확히 알지 못한다면 그 값을 변경하지 마십시오. 이러한 설정은 게임 성능에 큰 영향을 미칠 수 있습니다. 대부분의 사용자는 0.1과 10의 기본값을 사용해야 합니다."
