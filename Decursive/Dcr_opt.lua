                ...
                args = {
                    ...
                    Title = {
                        ...
                        name = (
                                    ...
                                    "2.6.0.1", "Archarodim", ("2010-12-06T01:26:14Z"):sub(1,10),
                                    L["ABOUT_NOTES"],
...
function D:ShowDebugReport()
    ...
    if not DebugHeader then
        DebugHeader = ("%s\n2.6.0.1  %s  CT: %0.4f D: %s %s (%s, %s, %s, %s)"):format((Dcr and Dcr.L) and Dcr.L["DEBUG_REPORT_HEADER"] or "X|cFF11FF33Please report the content of this window to Archarodim@teaser.fr|r\n|cFF009999(Use CTRL+A to select all and then CTRL+C to put the text in your clip-board)|r\n", DC.MyClass, D:NiceTime(), date(), GetLocale(), GetBuildInfo());
    end
...
T._LoadedFiles["Dcr_opt.lua"] = "2.6.0.1";
